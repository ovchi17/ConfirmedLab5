...
internal class SaveTest: KoinComponent {
    ...
    fun `Test Save functionality`(){
        ...
        val string1: String
        val string2: String = "[{\"id\":2,\"name\":\"AAA\",\"creationDate\":\"2023-03-25\",\"from\":{\"y\":3,\"x\":3,\"z\":3},\"to\":{\"y\":3,\"x\":3,\"z\":3},\"distance\":3,\"coordinates\":{\"x\":3,\"y\":3}}]"
        val sendList = mutableListOf<Any>()
        sendList.add("C:\\Users\\Akina\\IdeaProjects\\ConfirmedLab5\\src\\test\\kotlin\\commandsTest\\ex.txt")
